...
static inline void TRK_alloc_buf(void* ptr,
                                 const char* file,
                                 const char* func,
                                 u32 line) {
  u32 i, bucket;
...
static inline void TRK_free_buf(void* ptr,
                                const char* file,
                                const char* func,
                                u32 line) {
  u32 i, bucket;
...
static inline void* TRK_ck_realloc(void* orig,
                                   u32 size,
                                   const char* file,
                                   const char* func,
                                   u32 line) {
...
static inline void* TRK_ck_realloc_block(void* orig,
                                         u32 size,
                                         const char* file,
                                         const char* func,
                                         u32 line) {
...
static inline void* TRK_ck_strdup(u8* str,
                                  const char* file,
                                  const char* func,
                                  u32 line) {
...
static inline void* TRK_ck_memdup(void* mem,
                                  u32 size,
                                  const char* file,
                                  const char* func,
                                  u32 line) {
...
static inline void* TRK_ck_memdup_str(void* mem,
                                      u32 size,
                                      const char* file,
                                      const char* func,
                                      u32 line) {
...
static inline void TRK_ck_free(void* ptr,
                               const char* file,
                               const char* func,
                               u32 line) {
